\begin{center}
	...
	\fontsize{14pt}{0pt}\selectfont \textbf{\svhai}\\\vspace*{1.3cm}

	\fontsize{20pt}{0pt}\selectfont \textbf{\de}\\\vspace*{1.4cm}

	\fontsize{18pt}{0pt}\selectfont \textbf{BÁO CÁO MÔN HỌC}\\\vspace*{6pt}
	\fontsize{18pt}{0pt}\selectfont \textbf{\mon}\\\vspace*{1.8cm}
        
        \fontsize{14pt}{0pt}\selectfont Giảng viên hướng dẫn\\\vspace{6pt}
