...
\documentclass[10pt]{article} % Tạo một bản báo cáo với font size 10pt
...
\titleformat*{\subsubsection}{\fontsize{11pt}{0pt}\selectfont \bfseries \itshape}

\titlespacing*{\paragraph}{0pt}{0pt}{0pt} % Heading 4
\titleformat*{\paragraph}{\fontsize{10pt}{0pt}\selectfont \itshape}

\renewcommand{\figurename}{\fontsize{10pt}{0pt}\selectfont \bfseries Hình}
\renewcommand{\thefigure}{\thesection.\arabic{figure}}
\usepackage[font=bf]{caption}
\captionsetup[figure]{labelsep=space}

\renewcommand{\tablename}{\fontsize{10pt}{0pt}\selectfont \bfseries Bảng}
